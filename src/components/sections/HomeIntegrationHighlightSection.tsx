    ...
    <SectionWrapper withSectionSpacing={false} className="bg-brand-background pb-section pt-section">
      <div className="grid items-stretch gap-8 lg:grid-cols-[1.04fr_1fr] lg:gap-9">
        ...
        <div className="flex flex-col justify-between lg:py-2">
          <div>
            <h2 className="max-w-[15ch] text-[clamp(1.95rem,3.3vw,3.4rem)] font-medium leading-[1.1] text-brand-secondaryText lg:max-w-[15ch]">
            ...
            <ul className="mt-20 max-w-[42ch] space-y-2.5 text-[clamp(1rem,1.02vw,1.08rem)] leading-[1.55] text-brand-secondaryText">
